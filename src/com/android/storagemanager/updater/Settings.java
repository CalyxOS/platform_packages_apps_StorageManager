package com.android.storagemanager.updater;
...
public class Settings extends PreferenceActivity {
    ...
    static Intent getChangelogIntent(Context context, String filename) {
        ...
        final Uri uri = FileProvider.getUriForFile(context, "com.android.storagemanager.updater.fileprovider", changelogFile);
